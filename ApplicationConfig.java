...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.weizhang.project1.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "laiofferproject1.cwwbcnyeglhv.us-west-1.rds.amazonaws.com";
        String USERNAME = "ivyzhang333";
        String PASSWORD = "Ivy&6035";
